...
open(r"C:\Users\LIFE HOPE CENTER\AppData\Local\Temp\opencode\pyz_orig\pyc\app_decompiled_clean.py","w",encoding="utf-8").write(clean)
import ast
out=[]
try:
...
open(r"C:\Users\LIFE HOPE CENTER\AppData\Local\Temp\opencode\pyz_orig\pyc\ast_report2.txt","w",encoding="utf-8").write("\n".join(out))
print("done. null stripped. clean len=",len(clean))
